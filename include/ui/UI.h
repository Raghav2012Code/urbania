...
private:
    ...
    void drawBottomDock(TileType selectedBuildType, bool demolishMode,
    ...
    void drawRouteBanner(bool routeMode, const std::vector<int>& currentRouteStops);
    void drawToast(const std::string& msg, float timer, bool routeMode);
